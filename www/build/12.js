...
var CadastroAtendentePage = /** @class */ (function () {
    ...
    CadastroAtendentePage.prototype.validaSenha = function () {
    ...
    CadastroAtendentePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-cadastro-atendente',template:/*ion-inline-start:"C:\Users\jessica\Documents\GitHub\Hidroviva\src\pages\cadastro-atendente\cadastro-atendente.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>\n\n      AbrigaData \n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n<ion-list>\n\n  \n\n    <ion-item>\n\n      <ion-label stacked>Nome</ion-label>\n\n      <ion-input type="text" name="nome" [(ngModel)]="model.nome"></ion-input>\n\n    </ion-item>\n\n \n\n    <ion-item>\n\n      <ion-label stacked>Login</ion-label>\n\n      <ion-input type="text" name="login" [(ngModel)]="model.login"></ion-input>\n\n    </ion-item>\n\n	\n\n	<ion-item>\n\n      <ion-label stacked>Senha</ion-label>\n\n      <ion-input type="text" name="senha" [(ngModel)]="model.senha"></ion-input>\n\n    </ion-item> \n\n    <ion-item>\n\n      <ion-label stacked>Confirme a senha</ion-label>\n\n      <ion-input type="text" name="senha2" [(ngModel)]="senha"></ion-input>\n\n    </ion-item> \n\n \n\n  </ion-list>\n\n \n\n  <button ion-button block (click)="save()">Salvar</button>\n\n  \n\n\n\n  <ion-footer>\n\n  <ion-toolbar>\n\n    <p>© 2020 AbrigaData</p>\n\n  </ion-toolbar>\n\n</ion-footer>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\jessica\Documents\GitHub\Hidroviva\src\pages\cadastro-atendente\cadastro-atendente.html"*/,
        }),
