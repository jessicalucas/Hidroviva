    ...
    AtendenteProvider.prototype.insert = function (atendente) {
        return this.dbProvider.getDB()
            ...
            return db.executeSql(sql, data)
                .then(function (a) { return console.log("Cadastro de atendente inserido"); })
    ...
    GrupoFamiliarProvider.prototype.insert = function (grupo) {
        return this.dbProvider.getDB()
            ...
            db.executeSql('select max(cd_grupo) max from GrupoFamiliar', null)
                ...
                return db.executeSql(sql, data)
                    .then(function (a) { return console.log("Grupo Familiar inserido"); })
                    .catch(function (e) { return console.error(e); });
            });
        })
            .catch(function (e) { return console.error(e); });
...
var DatabaseProvider = /** @class */ (function () {
    ...
    DatabaseProvider.prototype.dropTables = function (db) {
        db.sqlBatch([["DROP TABLE IF EXISTS Localizacao"],
            ...
            .then(function () { return console.log('Tabelas dropadas'); })
            .catch(function (e) { return console.error('Erro ao dropar as tabelas', e); });
    };
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\jessica\Documents\GitHub\Hidroviva\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\jessica\Documents\GitHub\Hidroviva\src\app\app.html"*/
        }),
